...
/** 创建闪照图片消息(图片文件最大支持 28 MB）
 如果是系统相册拿的图片，需要先把图片导入 APP 的目录下
 identifierID  资源的唯一标识，用于重复图片附件上传去重。可以为空
 */
- (MSIMMessage *)createFlashImageMessage:(NSString *)imagePath identifierID:(nullable NSString *)identifierID;


/** 创建业务消息
 */
- (nullable MSIMMessage *)createBusinessMessage:(MSBusinessElem *)elem;
