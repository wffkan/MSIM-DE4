...
//  MSIMSDK
//
//  Created by benny wang on 2022/2/9.
//
...
/** 当message为图片闪照消息时有值*/
@property(nonatomic,strong,readonly,nullable) MSIMFlashElem *flashElem;

/** 当message为业务消息时有值*/
@property(nonatomic,strong,readonly,nullable) MSBusinessElem *businessElem;

/** 当message为透传的指令消息时有值*/
@property(nonatomic,strong,readonly,nullable) MSSignalElem *signalElem;
