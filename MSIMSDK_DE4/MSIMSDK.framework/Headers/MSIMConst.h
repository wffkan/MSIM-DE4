...
typedef NS_ENUM(NSInteger ,MSIMMessageType){
    ...
    MSIM_MSG_TYPE_UPLOAD_ABLUM_REQUEST = 35,//private album request
    
    MSIM_MSG_TYPE_UPLOAD_ABLUM_RESPONSE = 36,//accept private album request
    
    
    
    MSIM_MSG_TYPE_RECALL = 64,//消息撤回指令
