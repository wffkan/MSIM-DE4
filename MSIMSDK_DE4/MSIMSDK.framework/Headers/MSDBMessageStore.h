...
- (BOOL)updateFlashMessage:(MSIMMessage *)message;
...
- (void)requestHistoryMessageFromEnd:(NSInteger)msgEnd toStart:(NSInteger)msgStart partner_Id:(NSString *)partner_id result:(void(^)(NSArray<MSIMMessage *> *elems))result;
